...
class RouteTest extends TestCase
{
    ...
    {
        return new Route('/my-path/{test}/{test2}',
                         ['method' => 'get',
                          'name'   => 'my-route'],
    ...
    {
        $route = $this->getValidRoute();
        $this->assertEquals(['controller' => 'TestTestController'],
                            $route->getContext());
    }
    ...
    {
        $route = $this->getValidRoute();
        $context = ['controller' => 'Test2Test2Controller',
                    'function'   => 'MyFunction'];
    ...
    public function testGetMethods()
    {
        ...
        $this->assertEquals([Request::HTTP_METHOD_POST,
        ...
        $this->assertEquals([Request::HTTP_METHOD_GET,
    ...
    {
        $route = $this->getValidRoute();
        $this->assertEquals('/my-path/value1/value2',
